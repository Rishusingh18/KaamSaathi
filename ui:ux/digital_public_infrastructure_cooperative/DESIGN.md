...
- **Input Fields:** Minimum height `48px`, background `#FFFFFF`, border `1px solid #E2E8F0`, radius `8px`, text `#17212B`, placeholder `#94A3B8`.
...
- **e-Shram / Trust Status:** Pill badge with an icon and explicit text: "Consent-Based Verification" or "Pending Cooperative Attestation". Green tint (`#F0FDF4` background, `#16A34A` text, `#BBF7D0` border).
- **Warning / Action Required:** `#FFFBEB` background, `#D97706` text, `#FDE68A` border.
